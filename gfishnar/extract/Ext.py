...
class extract():
   	def __init__(self,gcode):
            ...
            self.X=extract.X(self,gcode)
            self.Y=extract.Y(self,gcode)
            self.layers=extract.layers(self,gcode)
            self.G=extract.G(self,gcode)
            self.sublayers=extract.sublayers(self,gcode)
